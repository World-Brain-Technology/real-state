...
<body>
                        ...
                        <div class="main__menu d-none d-xl-block">
                            <nav class="main__menu--navigation">
                                <ul class="main__menu--wrapper d-flex">
                                    ...
                                    <li class="main__menu--items">
                                        <a class="main__menu--link" href="../listing.html"> Listing 
                                            <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </a>  
                                    ...
                                    <li class="main__menu--items">
                                        ...
                                        <ul class="sub__menu">
                                            ...
                                            <li class="sub__menu--items"><a href="./create-listing.html" class="sub__menu--link">Creat Listing</a></li>
            ...
            <main class="main__content_wrapper">
                ...
                <div class="dashboard__container add__property--container">
                    <div class="add__property--heading mb-30">
                        <?php include("../backend/handlers/notification.handler.php") ?>
                        ...
                        <div class="add__property--step left">
                            <div class="add__property--step__inner">
                                <div class="add__property--box mb-30">
                                    ...
                                    <form class="add__property--form" name="create_listing" action="" method="post">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="add__listing--input__box mb-20">
                                                    <label class="add__listing--input__label" for="input1">Title</label>
                                                    <input class="add__listing--input__field" id="input1" name="title" placeholder="title" type="text">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="add__listing--textarea__box mb-15">
                                                    <label class="add__listing--input__label" for="input2">Description</label>
                                                    <textarea class="add__listing--textarea__field" name="description" id="input2" placeholder="Description"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="add__listing--input__box mb-20">
                                                    ...
                                                    <div class="select position-relative">
                                                        <select class="add__listing--form__select" name="type">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="add__listing--input__box mb-20">
                                                    ...
                                                    <div class="select position-relative">
                                                        <select class="add__listing--form__select" name="status">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="add__listing--input__box mb-20">
                                                    ...
                                                    <input class="add__listing--input__field" id="input3" name="price" placeholder="Price" type="number">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="add__listing--input__box mb-20">
                                                    <label class="add__listing--input__label" for="input4">Area</label>
                                                    <input class="add__listing--input__field" id="input4"name="area" placeholder="Description" type="text">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="add__listing--input__box mb-20">
                                                    ...
                                                    <div class="select position-relative">
                                                        <select class="add__listing--form__select" name="rooms">
                                                            <option selected="">Rooms</option>
                                                            <option value="room 3">Rooms 3</option>
                                                            <option value="room 4">Rooms 4</option>
                                                            <option value="room 5">Rooms 5</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="solid__btn add__property--btn" type="submit" name="create_listing">Save</button>
                                    </form>
    ...
    <?php
        include_once("../backend/configs/db.config.php");
        include_once("../backend/services/listing.service.php");
        include_once("../backend/utils/helper_functions.php");
        include_once("../backend/controllers/listing.controller.php");
        include_once("../backend/handlers/listing.handler.php");
        ?>
