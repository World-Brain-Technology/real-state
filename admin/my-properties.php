                        ...
                        <div class="main__menu d-none d-xl-block">
                            <nav class="main__menu--navigation">
                                <ul class="main__menu--wrapper d-flex">
                                    ...
                                    <!-- ABOUT US -->
                                <li class="main__menu--items">
                                    <a class="main__menu--link" href="#">About Us</a>  
                                </li>
            ...
            <main class="main__content_wrapper">
                ...
                <div class="dashboard__container dashboard__reviews--container">
                    ...
                    <?php 
                        ...
                        include_once("../backend/handlers/notification.handler.php");
                    ?>
                                            ...
                                            <td>
                                                <div class="properties__author d-flex align-items-center">
                                                    ...
                                                    <div class="reviews__author--text">
                                                        <h3 class="reviews__author--title"><?php echo htmlspecialchars($property['title']); ?></h3>
                                                        <p class="reviews__author--subtitle"><?php echo htmlspecialchars($property['description']); ?></p>
                                                        <span class="properties__author--price">$<?php echo number_format($property['price'], 2); ?>/mo</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="reviews__date"><?= htmlspecialchars($property['created_at']); ?></span>
                                            </td>
                                            <td>
                                                <span class="status__btn <?php echo strtolower($property['status']); ?>">
                                                    <?php echo ucfirst($property['status']); ?>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="properties__views">views</span>
                                            </td>
                                            <td>
                                                <div class="reviews__action--wrapper position-relative">
                                                    ...
                                                    <ul class="dropdown-menu sold-out__user--dropdown" data-popper-placement="bottom-start">
                                                        ...
                                                        <li><a href="?delete=true&id=<?=$property["id"]?>">Remove</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
